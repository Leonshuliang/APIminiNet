...
public class ShowPersonProfile extends JDialog{  
    ...
    // 
    // 
    public ShowPersonProfile(MouseAdapter mouseAdapter,String title ,boolean modal,PeopleTable sm,int rowNums)  
    {  
...
//put all buttons in panel
  ...
  //
      ...
      ImageIcon ii = new ImageIcon("./person2.jpg");
